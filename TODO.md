...
Language: English for code, documentation, repository content, and interface explanations. Preserve official Indonesian tax terms.
...
- [x] **1. Bootstrap the web application**
...
- [x] **2. Define the synthetic tax data and state transitions**
...
- [x] **3. Build the Indonesian app shell and simulated login**
...
- [x] **4. Build the fictional document center and BPA1 parser**
...
- [x] **5. Implement draft creation, posting, and progress**
...
- [x] **6. Implement the main return and conditional sections**
...
- [x] **7. Implement assets, liabilities, dependents, and activity history**
...
- [x] **8. Add validation, calculation, legal guidance, and review**
...
- [x] **9. Register state-aware WebMCP read tools**
...
- [x] **10. Register controlled WebMCP mutation tools**
...
- [x] **11. Add simulated submission, receipt, and benchmark modes**
...
- [ ] **12. Complete security, accessibility, documentation, and submission evidence**
  Status: Security controls, dependency audit, responsive accessibility basics, README, and demo outline are implemented. Final screenshots, keyboard walkthrough, network inspection, and WebMCP-enabled browser recording remain intentionally unchecked until they are run in the judging browser.
